...
func Test_Binary(t *testing.T) {
	convey.Convey("All func should be passed", t, func() {
		...
		convey.So(GetUintLE(x, 2) == 0xAB, convey.ShouldBeTrue)
		convey.So(binary.LittleEndian.Uint16(x) == 0xAB, convey.ShouldBeTrue)

		PutUintBE(x, 2, uint64(0xAB))
		convey.So(GetUintBE(x, 2) == 0xAB, convey.ShouldBeTrue)
		convey.So(binary.BigEndian.Uint16(x) == 0xAB, convey.ShouldBeTrue)

		PutUintLE(x, 4, uint64(0xABCD))
		convey.So(GetUintLE(x, 4) == 0xABCD, convey.ShouldBeTrue)
		convey.So(binary.LittleEndian.Uint32(x) == 0xABCD, convey.ShouldBeTrue)

		PutUintBE(x, 4, uint64(0xABCD))
		convey.So(GetUintBE(x, 4) == 0xABCD, convey.ShouldBeTrue)
		convey.So(binary.BigEndian.Uint32(x) == 0xABCD, convey.ShouldBeTrue)

		PutUintLE(x, 8, uint64(0xABCDEFAB))
		convey.So(GetUintLE(x, 8) == 0xABCDEFAB, convey.ShouldBeTrue)
		convey.So(binary.LittleEndian.Uint64(x) == 0xABCDEFAB, convey.ShouldBeTrue)

		PutUintBE(x, 8, uint64(0xABCDEFAB))
		convey.So(GetUintBE(x, 8) == 0xABCDEFAB, convey.ShouldBeTrue)
		convey.So(binary.BigEndian.Uint64(x) == 0xABCDEFAB, convey.ShouldBeTrue)
	})
}
