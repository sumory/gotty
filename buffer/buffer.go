...
func NewBuffer(size, capacity int) *Buffer {
...
func (b *Buffer) WriteUint24BE(v uint32) {
	i := b.grows(3)
	utils.PutUint24BE(b.Data[i:], v)
}

func (b *Buffer) WriteUint24LE(v uint32) {
	i := b.grows(3)
	utils.PutUint24LE(b.Data[i:], v)
}
...
func (b *Buffer) ReadUint24BE() uint32 {
	r := utils.GetUint24BE(b.Data[b.ReadPos:])
	b.ReadPos += 3
	return r
}

func (b *Buffer) ReadUint24LE() uint32 {
	r := utils.GetUint24LE(b.Data[b.ReadPos:])
	b.ReadPos += 3
	return r
}
...
func (b *Buffer) ReadUint40BE() uint64 {
	r := utils.GetUint40BE(b.Data[b.ReadPos:])
	b.ReadPos += 5
	return r
}

func (b *Buffer) ReadUint40LE() uint64 {
	r := utils.GetUint40LE(b.Data[b.ReadPos:])
	b.ReadPos += 5
	return r
}

func (b *Buffer) ReadUint48BE() uint64 {
	r := utils.GetUint48BE(b.Data[b.ReadPos:])
	b.ReadPos += 6
	return r
}

func (b *Buffer) ReadUint48LE() uint64 {
	r := utils.GetUint48LE(b.Data[b.ReadPos:])
	b.ReadPos += 6
	return r
}

func (b *Buffer) ReadUint56BE() uint64 {
	r := utils.GetUint56BE(b.Data[b.ReadPos:])
	b.ReadPos += 7
	return r
}

func (b *Buffer) ReadUint56LE() uint64 {
	r := utils.GetUint56LE(b.Data[b.ReadPos:])
	b.ReadPos += 7
	return r
}
